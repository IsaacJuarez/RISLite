                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                <span class="input-icon" style="width:100%">
                                    ...
                                    <asp:TextBox ID="txtBusquedaEstudio" runat="server" CssClass="nav-search-input" placeholder="Estudio..." ToolTip="Seleccionar Estudio" Width="100%" OnTextChanged="txtBusquedaEstudio_TextChanged" Enabled="false"></asp:TextBox>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
                        <ajaxToolkit:TabContainer runat="server" ActiveTabIndex="0">
                            <asp:TabPanel runat="server" HeaderText="Sugerencias" ID="tbSug">
                                <ContentTemplate>
									<div class="widget-main">
                                        <asp:UpdatePanel runat="server">
                                            <ContentTemplate>
                                                <p><asp:Label runat="server" id="lblTituloSug" Text="Elegir un estudio" ForeColor="DarkGreen"></asp:Label></p>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                                <div class="row form-group">
                            ...
                            <asp:TabPanel ID="tbAgenda" runat="server" HeaderText="Agenda">
                                <ContentTemplate>
