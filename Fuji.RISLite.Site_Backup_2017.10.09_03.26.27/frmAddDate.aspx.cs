            ...
            try
            {
                ...
                switch (e.CommandName)
                {
                    case "ElegirHorario":
                        ...
                        Session["intModSug"] = lstEstudios.First(x => x.intRelModPres == inrRelModPres).intModalidadID.ToString();
                    ...
                    case "Eliminar":
                        inrRelModPres = Convert.ToInt32(e.CommandArgument.ToString());
                        var itemToRemove = lstEstudios.Single(r => r.intRelModPres == inrRelModPres);
                        lstEstudios.Remove(itemToRemove);
            ...
            try
            {
                ...
                switch (e.CommandName)
                {
                    case "Seleccionar":
                        ...
                        lstEstudios.First(x => x.intRelModPres == Convert.ToInt32(Session["inrRelModPres"])).fechaInicio = mdl.datFecha;
                        lstEstudios.First(x => x.intRelModPres == Convert.ToInt32(Session["inrRelModPres"])).fechaFin = datFechaFin;
                        grvEstudios.DataSource = null;
                        grvEstudios.DataSource = lstEstudios;
                        grvEstudios.DataBind();
                        lstSug = null;
