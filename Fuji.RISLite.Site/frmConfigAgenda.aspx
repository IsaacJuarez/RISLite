...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="RB_Agergar_Modalidad">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="txt_Modalidad" />
                    <telerik:AjaxUpdatedControl ControlID="txtDescripcion" />
                    <telerik:AjaxUpdatedControl ControlID="DDL_duracion_Nuevo" />
                    <telerik:AjaxUpdatedControl ControlID="GV_Agenda" />
                    <telerik:AjaxUpdatedControl ControlID="alert_container" />
                    <telerik:AjaxUpdatedControl ControlID="RCP_add_modadlidad" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            ...
            <telerik:AjaxSetting AjaxControlID="RCB_Sitio_confiagenda">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RTP_Inicio" />
                    <telerik:AjaxUpdatedControl ControlID="RTP_Fin" />
                    <telerik:AjaxUpdatedControl ControlID="RB_Lunes" />                    
                    ...
                    <telerik:AjaxUpdatedControl ControlID="RBSabado" />
                    <telerik:AjaxUpdatedControl ControlID="RB_Domingo" />
                    <telerik:AjaxUpdatedControl ControlID="RDL_DiaFeriado" />
                    <telerik:AjaxUpdatedControl ControlID="RDL_HM" />
    ...
    <telerik:RadScriptBlock runat="server" ID="RadCodeBlock1">
        <script type="text/javascript">
            ...
            function Carga_moalidad_sitio(sender, eventArgs) {
                //var evento = eventArgs.Command.get_name();
                var idsitio = sender._value;
                $find("<%= RadAjaxPanel4.ClientID%>").ajaxRequestWithTarget("<%= RadAjaxPanel4.UniqueID %>", idsitio);
            }

            function Carga_config_agenda(sender, eventArgs) {
                <%--//var evento = eventArgs.Command.get_name();
                var idsitio = sender._value;
                $find("<%= RadAjaxPanel5.ClientID%>").ajaxRequestWithTarget("<%= RadAjaxPanel5.UniqueID %>", idsitio);--%>
            }
            ...
            function validar_Modalidad(sender, args) {
            }
            ...
            <div class="tabbable tabs-left" id="Tabs">
                ...
                <div class="tab-content">
                    ...
                    <div id="ConfbasicaAgenda" class="tab-pane in active">
                        <div class="widget-box">
                            <div class="widget-header"> 
                             ...
                             <telerik:RadAjaxPanel ID="RadAjaxPanel5" runat="server"  OnAjaxRequest="RadAjaxPanel5_AjaxRequest">
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-7 right">
                                                             <telerik:RadComboBox ID="RCB_Sitio_confiagenda" runat="server"  DataSourceID="SDS_Sitio" Width="100%" 
                                                              OnSelectedIndexChanged ="RCB_Sitio_confiagenda_SelectedIndexChanged" AutoPostBack="true"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-1 center-block">
                                                            <telerik:RadTimePicker ID="RTP_Inicio" runat="server" OnSelectedDateChanged="RTP_Inicio_SelectedDateChanged" AutoPostBack="true"
                                                                TimeView-HeaderText="Desde" onkeypress="return solonumeros(event);">
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-sm-1">
                                                        <telerik:RadButton ID="RB_agregar_DiaFeriado" runat="server" Text="Agregar" CssClass="btn btn-success"
                                                            OnClick="RadButton1_Click" OnClientClicking="validar_fecha_duplicada">
                                                        </telerik:RadButton>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <telerik:RadTimePicker ID="RTP_HM_Inicio" runat="server" TimeView-HeaderText="Desde" onkeypress="return solonumeros(event);"
                                                            OnSelectedDateChanged="RTP_HM_Inicio_SelectedDateChanged" AutoPostBack="true">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <telerik:RadButton ID="RB_Agregar_HM" runat="server" Text="Agregar" CssClass="btn btn-success"
                                                            OnClick="RB_Agregar_HM_Click" OnClientClicking="validar">
                                                        </telerik:RadButton>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-1 center-block">
                                                            <telerik:RadButton ID="RB_intervalo" runat="server" Text="Establecer" CssClass="btn btn-success"
                                                                OnClick="RB_intervalo_Click" Enabled="false">
                                                            </telerik:RadButton>
                                                        </div>
                    ...
                    <div id="Confadminagenda" class="tab-pane">
                        <div class="widget-box">
                            <div class="widget-header">
                                <h4 class="widget-title">Administración de agenda</h4>
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    <telerik:RadAjaxPanel ID="RadAjaxPanel4" runat="server" OnAjaxRequest="RadAjaxPanel4_AjaxRequest">
                                      ...
                                      <div class="row form-group">
                                        ...
                                        <div class="col-lg-2 col-sm-12">
                                         ...
                                         <div class="col-lg-2 col-sm-12 center-block">
                                          <asp:Label ID="Label6" runat="server" Text="Sitio"></asp:Label>
                                               </div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-lg-2 col-sm-12">
                                            <asp:TextBox runat="server" ID="txt_Modalidad" Text="" CssClass="form-control" placeholder="Modalidad"></asp:TextBox>
                                        ...
                                        <div class="col-lg-2 col-sm-12">
                                            <%--<asp:TextBox runat="server" ID="txtDuracion" Text="" CssClass="form-control" placeholder="Duración"></asp:TextBox>--%>
                                            <asp:DropDownList ID="DDL_duracion_Nuevo" runat="server" DataSourceID="SDS_duracion" Width="100%"
                                                DataTextField="intDuracion" DataValueField="intDuracionModalidadID">
                                            </asp:DropDownList>
                                            <%--<asp:RequiredFieldValidator ID="rfvModalidad" runat="server" Text="* Capturar Duración." ForeColor="Red" ControlToValidate="txtDuracion" ValidationGroup="Agregar_Modalidad"></asp:RequiredFieldValidator>--%>
                                        </div>

                                          
                                         <div class="col-lg-2 col-sm-12 center-block">
                                        <%--  <asp:DropDownList ID="DDL_Sitio" runat="server" DataSourceID="SDS_Sitio" Width="100%"
                                                DataTextField="vchNombreSitio" DataValueField="intSitioID" on OnSelectedIndexChanged="DDL_Sitio_SelectedIndexChanged" >
                                            </asp:DropDownList>--%>
                                             <telerik:RadComboBox ID="RCB_SItio" runat="server"  DataSourceID="SDS_Sitio" Width="100%"
                                                DataTextField="vchNombreSitio" DataValueField="intSitioID" OnClientSelectedIndexChanged="Carga_moalidad_sitio"></telerik:RadComboBox>
                                        ...
                                        <div class="col-lg-1 col-sm-12 center-block">
                                            <telerik:RadButton ID="RB_Agergar_Modalidad" runat="server" Text="Agregar" CssClass="btn btn-success"
                                                OnClick="btnAgregar_Click1" OnClientClicking="validar_Modalidad" ValidationGroup="Agregar_Modalidad">
                                            </telerik:RadButton>
                                        </div>
                                    </div>

                                    <asp:GridView ID="GV_Agenda" runat="server" AllowPaging="true" CssClass="table table-striped table-bordered"
                                        PageSize="20" AutoGenerateColumns="false" OnRowDataBound="GV_Agenda_RowDataBound" Font-Size="10px"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Duracion">
                                                <ItemTemplate>
                                                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("intDuracionGen") %>'></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:DropDownList ID="DDL_duracion" runat="server" DataSourceID="SDS_duracion"
                                                        DataTextField="intDuracion" DataValueField="intDuracionModalidadID">
                                                    </asp:DropDownList>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
                    ...
                    <asp:SqlDataSource ID="SDS_duracion" runat="server"
                        ConnectionString="<%$ ConnectionStrings:BD2 %>"
                        SelectCommand="SELECT * FROM [tbl_CAT_DuracionModalidad] WHERE bitActivo = 'True'"></asp:SqlDataSource>

                     <asp:SqlDataSource ID="SDS_Sitio" runat="server"
                        ConnectionString="<%$ ConnectionStrings:BD2 %>"
                        SelectCommand="SELECT * FROM [tbl_CAT_Sitio] WHERE bitActivo = 'True'"></asp:SqlDataSource>
