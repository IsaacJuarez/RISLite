                ...
                if ((Date2 - Date1) < 0) {
                    ...
                    for (index = 0; index < lista_horas.length; ++index) {
                        ...
                        if (lista_horas[index] != "") {
                            ...
                            //if (Date1.getTime() <= desde && Date1.getTime() >= hasta) {
                            //    alert("El periodo de tiempo insertado ya esta en el sistema");       
                            //}

                            var timepicker = $find("<%=RTP_HM_Inicio.ClientID %>");
                            var time = timepicker.get_dateInput().get_value();
                        

                            if (hora_insertada >= desde) {
                                document.getElementById("HF_validacion_HM").value = "true";
                                alert("El periodo de tiempo insertado ya esta tomado en cuenta");
                            }

                            //if (Date2.getTime() >= desde) {
                            //    document.getElementById("HF_validacion_HM").value = "true";
                            //    alert("El periodo de tiempo insertado ya esta tomado en cuenta");
                            //}
                                         ...
                                         <div class="widget-body">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-1 center-block">
                                                                            <telerik:RadTimePicker ID="RTP_Inicio" runat="server" OnSelectedDateChanged="RTP_Inicio_SelectedDateChanged" AutoPostBack="true"
                                                                                TimeView-HeaderText="Desde"></telerik:RadTimePicker>
                                                                        ...
                                                                        <div class="col-sm-1 center-block">
                                                                                 <telerik:RadTimePicker ID="RTP_Fin" runat="server" TimeView-HeaderText="Hasta"></telerik:RadTimePicker>
                                                                        </div>
                                                        ...
                                                        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
                                                            <div  class="row">
                                                                    ...
                                                                    <div class="col-sm-2">
                                                                          <telerik:RadTimePicker ID="RTP_HM_Inicio" runat="server" TimeView-HeaderText="Desde" 
                                                                    ...
                                                                    <div class="col-sm-2">
                                                                        <telerik:RadTimePicker ID="RTP_HM_Fin" runat="server" TimeView-HeaderText="Hasta">
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:Panel runat="server">
                                                            <asp:GridView ID="GV_Agenda" runat="server" AllowPaging="true" CssClass="table table-striped table-bordered"
                                                                    ...
                                                                    OnRowCommand="GV_Agenda_RowCommand" UpdateMode="Conditional" OnRowUpdated="GV_Agenda_RowUpdated" OnRowUpdating="GV_Agenda_RowUpdating"
